...
class Compiler {
    ...
    compileWithCustomNotations(char, string) {
        for (let customNotation of this.customNotations) {
            if (customNotation.character) {
                if (customNotation.isOptional) {
                    return new model_1.OptionalValueState(this._compile(string.substring(1), true, false, char), new model_1.OptionalValueState.Custom(char, customNotation.characterSet));
                }
                else {
                    return new model_1.ValueState(this._compile(string.substring(1), true, false, char), new model_1.ValueState.Custom(char, customNotation.characterSet));
                }
            }
        }
        throw new Error("Wrong format");
