(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('gauge-chart'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('angular-gauge-chart', ['exports', 'gauge-chart', '@angular/core'], factory) :
    (factory((global['angular-gauge-chart'] = {}),global.GaugeChart,global.ng.core));
}(this, (function (exports,GaugeChart,core) { 'use strict';
    ...
    var GaugeChartComponent = /** @class */ (function () {
        ...
        GaugeChartComponent.propDecorators = {
            gaugeArea: [{ type: core.ViewChild, args: ['gaugeArea',] }],
