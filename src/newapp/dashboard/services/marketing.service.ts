...
export class MarketingService {
    ...
    mkNewPatientsByReferral(
        ...
        return this.http
        .get(
            `${this.apiUrl}/Marketing/mkNumPatientsByReferral`,
            {
                params: {
                    clinic_id: clinicId,
    ...
    mkNewPatientsByReferralTrend(
        ...
        return this.http
        .get(
            `${this.apiUrl}/Marketing/mkNumPatientsByReferralTrend`,
            {
                params: {
                    clinic_id: clinicId,
                    mode,
        ...
        .pipe(
            map((resBody) => <MkNewPatientsByReferralTrendApiResponse> camelcaseKeys(resBody, {deep: true}))
        );
    }
    ...
    mkRevByReferral(
        ...
        return this.http
        .get(
            `${this.apiUrl}/Marketing/mkRevByReferral`,
            {
                params: {
                    clinic_id: clinicId,
                    start_date: startDate,
        ...
        .pipe(
            map((resBody) => <MkRevenueByReferralApiResponse> camelcaseKeys(resBody, {deep: true}))
        );
    }
    ...
    mkRevByReferralTrend(
        ...
        return this.http
        .get(
            `${this.apiUrl}/Marketing/mkRevByReferralTrend`,
            {
                params: {
                    clinic_id: clinicId,
                    mode,
    ...
    mkNumNewPatients(
        ...
        return this.http
        .get(
            `${this.apiUrl}/Marketing/mkNumNewPatients`,
            {
                params: {
                    clinic_id: clinicId,
                    start_date: startDate,
        ...
        .pipe(
            map((resBody) => <MkNumNewPatientsApiResponse> camelcaseKeys(resBody, {deep: true}))
        );
    }
    ...
    mkNumNewPatientsTrend(
        ...
        return this.http
        .get(
            `${this.apiUrl}/Marketing/mkNumNewPatientsTrend`,
            {
                params: {
                    clinic_id: clinicId,
                    mode,
    ...
    mkNewPatientAcq(
        ...
        return this.http
        .get(
            `${this.apiUrl}/Marketing/mk${connectedWith == 'myob'? 'Myob': ''}NewPatientAcq`,
            {
                params: {
                    clinic_id: clinicId,
                    start_date: startDate,
        ...
        .pipe(
            map((resBody) => <MkNewPatientAcqApiResponse> camelcaseKeys(resBody, {deep: true}))
        );
    }
    ...
    mkNewPatientAcqTrend(
        ...
        return this.http
        .get(
            `${this.apiUrl}/Marketing/mk${connectedWith == 'myob'? 'Myob': ''}NewPatientAcqTrend`,
            {
                params: {
                    clinic_id: clinicId,
                    mode: mode,
    ...
    mkTotalVisits(
        ...
        return this.http
        .get(
            `${this.apiUrl}/Marketing/mkTotalVisits`,
            {
                params: {
                    clinic_id: clinicId,
                    start_date: startDate,
        ...
        .pipe(
            map((resBody) => <MkTotalVisitsApiResponse> camelcaseKeys(resBody, {deep: true}))
        );
    }
    ...
    mkTotalVisitsTrend(
        ...
        return this.http
        .get(
            `${this.apiUrl}/Marketing/mkTotalVisitsTrend`,
            {
                params: {
                    clinic_id: clinicId,
                    mode,
        ...
        .pipe(
            map((resBody) => <MkTotalVisitsTrendApiResponse> camelcaseKeys(resBody, {deep: true}))
        );
    }
    ...
    mkActivePatients(
        ...
        return this.http
        .get(
            `${this.apiUrl}/Marketing/mkActivePatients`,
            {
                params: {
                    clinic_id: clinicId,
                    start_date: startDate,
        ...
        .pipe(
            map((resBody) => <MkActivePatientsApiResponse> camelcaseKeys(resBody, {deep: true}))
        );
    }
    ...
    mkActivePatientsTrend(
        ...
        return this.http
        .get(
            `${this.apiUrl}/Marketing/mkActivePatientsTrend`,
            {
                params: {
                    clinic_id: clinicId,
                    mode,
