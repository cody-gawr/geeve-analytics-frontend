...
import { DashboardState, selectChartTips, selectErrors } from '../state/reducers/dashboard.reducer';
...
export class DashboardFacade {
  ...
  public loadChartTips(dashboardId: number, clinicId: string | number) {
    this.store.dispatch(DashboardPageActions.loadChartTips({ dashboardId, clinicId }));
  }
}
