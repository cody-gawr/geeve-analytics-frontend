...
import {
  FrontDeskState,
  selectErrors,
  selectFdFtaRatioChartData,
  selectFdFtaRatioTrendChartData,
  selectFdNumTicksChartData,
  selectFdNumTicksTrendChartData,
  selectFdReappointRateChartData,
  selectFdReappointRateTrendChartData,
  selectFdRecallRateChartData,
  selectFdRecallRateTrendChartData,
  selectFdUtaRatioChartData,
  selectFdUtaRatioTrendChartData,
  selectFdUtilRateByDayChartData,
  selectFdUtilRateChartData,
...
export class FrontDeskFacade {
  ...
  public setIsByDayData(value: boolean) {
    this.store.dispatch(FrontDeskPageActions.setIsByDayData({ value }));
  }
