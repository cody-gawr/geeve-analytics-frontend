...
import { FdFtaRatioApiResponse, FdFtaRatioTrendApiResponse, FdNumTicksApiResponse, FdNumTicksTrendApiResponse, FdReappointRateApiResponse, FdReappointRateTrendApiResponse, FdRecallRateApiResponse, FdRecallRateTrendApiResponse, FdUtaRatioApiResponse, FdUtaRatioTrendApiResponse, FdUtilisationRateApiResponse, FdUtilisationRateByDayApiResponse, FdUtilisationRateTrendApiResponse } from '@/newapp/models/dashboard/front-desk';
