...
export class FollowupsService {
  ...
  followupPostOpCalls(clinic_id, month, year): Observable<any> {
    ...
    return this.http
      .get(
        this.apiUrl +
          '/Followups/fuPostOpTable?clinic_id=' +
          clinic_id +
          '&month=' +
          month +
          '&year=' +
  ...
  followupTickFollowups(clinic_id, month, year): Observable<any> {
    ...
    return this.http
      .get(
        this.apiUrl +
          '/Followups/fuTickFollowupsTable?clinic_id=' +
          clinic_id +
          '&month=' +
          month +
          '&year=' +
  ...
  followupFtaFollowups(clinic_id, month, year): Observable<any> {
    ...
    return this.http
      .get(
        this.apiUrl +
          '/Followups/fuFtaFollowupsTable?clinic_id=' +
          clinic_id +
          '&month=' +
          month +
          '&year=' +
  ...
  followupUtaFollowups(clinic_id, month, year): Observable<any> {
    ...
    return this.http
      .get(
        this.apiUrl +
          '/Followups/fuUtaFollowupsTable?clinic_id=' +
          clinic_id +
          '&month=' +
          month +
          '&year=' +
  ...
  followupOverdueRecalls(clinic_id, month, year): Observable<any> {
    ...
    return this.http
      .get(
        this.apiUrl +
          '/Followups/fuOverdueRecallsTable?clinic_id=' +
          clinic_id +
          '&month=' +
          month +
          '&year=' +
  ...
  internalReferrals(clinic_id, month, year): Observable<any> {
    ...
    return this.http
      .get(
        this.apiUrl +
          '/Followups/fuInternalReferralsTable?clinic_id=' +
          clinic_id +
          '&month=' +
          month +
          '&year=' +
  ...
  checkExportFollowUpData(clinic_id, startDate, endDate, showcompleted, followuptype): any {
    ...
    return this.http.get(
      this.apiUrl +
        '/Followups/fuCheckExportFollowUpData?startDate=' +
        startDate +
        '&endDate=' +
        endDate +
        '&clinic_id=' +
  ...
  exportFollowUp(
    ...
    return this.http.get(
      this.apiUrl +
        '/Followups/exportFollowUp?startDate=' +
        startDate +
        '&endDate=' +
        endDate +
        '&clinic_id=' +
  ...
  deletefiles(filename, filetype): any {
    let header = this.getHeaders();
    return this.http.get(
      this.apiUrl + '/Followups/fuDeletefiles?filename=' + filename + '&filetype=' + filetype,
      header,
    );
  }
  ...
  updateFollowUpStatus(
    ...
    return this.http.post(this.apiUrl + '/Followups/fuUpdateFollowupStatus', formData, header).pipe(
      map((response: HttpResponse<Object>) => {
        return response;
      }),
    );
  ...
  updateStatus(event, pid, cid, type, previousDays, fdate, treatItem = ''): Observable<any> {
    ...
    return this.http.post(this.apiUrl + '/Followups/fuUpdateStatus', formData, header).pipe(
      map((response: HttpResponse<Object>) => {
        return response;
      }),
    );
  ...
  cloneRecord(
    ...
    return this.http.post(this.apiUrl + '/Followups/fuCloneStatus', formData, header).pipe(
