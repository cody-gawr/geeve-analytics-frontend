      ...
      .subscribe({
        next: res => {
          ...
          if (res.status == 200) {
            ...
            datares['show_pay_promo'] = res.body.data.data.show_pay_promo;
            ...
            var nextStep = (datares['stepper_status'] + 1).toString();
            ...
            this._cookieService.put('dash1_multi', res.body.data.data.dash1_multi, opts);
            this._cookieService.put('mfa_enabled', datares['mfa_enabled']);
            this._cookieService.put('dash2_multi', res.body.data.data.dash2_multi, opts);
            this._cookieService.put('dash3_multi', res.body.data.data.dash3_multi, opts);
            this._cookieService.put('dash4_multi', res.body.data.data.dash4_multi, opts);
            this._cookieService.put('dash5_multi', res.body.data.data.dash5_multi, opts);
            ...
            sessionStorage.setItem('show_pay_promo', datares['show_pay_promo']);

            this._cookieService.put('health_screen_mtd', datares['health_screen_mtd'], opts);

            this._cookieService.put('max_chart_bars', datares['max_chart_bars'], opts);
