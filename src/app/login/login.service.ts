...
export class LoginService {
  ...
  me() {
    this.http
      ...
      .subscribe((body: any) => {
        if (body.status === 200) this.updateUserInfo(body.data);
      });
  }
  ...
  updateUserInfo(data) {
    ...
    datares['features_dismissed'] = data.features_dismissed;
    datares['show_pay_promo'] = data.show_pay_promo;
    ...
    this._cookieService.put('dash1_multi', data.dash1_multi, opts);
    this._cookieService.put('mfa_enabled', datares['mfa_enabled']);
    this._cookieService.put('dash2_multi', data.dash2_multi, opts);
    this._cookieService.put('dash3_multi', data.dash3_multi, opts);
    this._cookieService.put('dash4_multi', data.dash4_multi, opts);
    this._cookieService.put('dash5_multi', data.dash5_multi, opts);
