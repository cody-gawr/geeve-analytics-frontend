...
export class ClinicianProceeduresService {
  ...
  ItemsPredictorAnalysis(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/ClinicianProcedures/cpPredictorAnalysis?clinic_id=' +
          clinic_id +
          '&start_date=' +
          startDate +
          '&end_date=' +
  ...
  ItemsPredictorAnalysisSpecial(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/ClinicianProcedures/cpPredictorSpecialistAnalysis?clinic_id=' +
          clinic_id +
          '&start_date=' +
          startDate +
          '&end_date=' +
  ...
  ItemsPredictorAnalysisTrendDentist(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/ClinicianProcedures/cpPredictorAnalysisTrend?clinic_id=' +
          clinic_id +
          '&provider_id=' +
          dentist_id +
          '&mode=' +
  ...
  ItemsPredictorAnalysisSpecialTrendDentist(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/ClinicianProcedures/cpPredictorSpecialistAnalysisTrend?clinic_id=' +
          clinic_id +
          '&provider_id=' +
          dentist_id +
          '&mode=' +
  ...
  PredictorRatio(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/ClinicianProcedures/cpPredictorRatio?clinic_id=' +
          clinic_id +
          '&start_date=' +
          startDate +
          '&end_date=' +
  ...
  ClinicianProceedure(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/ClinicianProcedures/cpRevPerProcedure?clinic_id=' +
          clinic_id +
          '&start_date=' +
          startDate +
          '&end_date=' +
  ...
  ClinicianReferral(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/ClinicianProcedures/cpReferrals?clinic_id=' +
          clinic_id +
          '&start_date=' +
          startDate +
          '&end_date=' +
  ...
  ClinicianReferralTrendDentist(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/ClinicianProcedures/cpReferralsTrend?clinic_id=' +
          clinic_id +
          '&mode=' +
          mode +
          '&provider_id=' +
  ...
  CpPredictorRatioTrend(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/ClinicianProcedures/cpPredictorRatioTrend?clinic_id=' +
          clinic_id +
          '&mode=' +
          mode +
          '&provider_id=' +
