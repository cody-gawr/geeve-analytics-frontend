...
export class FinancesService {
  ...
  NetProfit(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/Finance/finNetProfit?clinic_id=' +
          clinic_id +
          '&start_date=' +
          startDate +
          '&end_date=' +
  ...
  NetProfitPercent(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/Finance/finNetProfitPercent?clinic_id=' +
          clinic_id +
          '&start_date=' +
          startDate +
          '&end_date=' +
  ...
  netProfitPercentage(
    ...
    if (connectedwith == 'xero') {
      return this.http
        .get(
          this.apiUrl +
            '/Finance/fnNetProfitPercentage?clinic_id=' +
            clinic_id +
            '&start_date=' +
            startDate +
            '&end_date=' +
  ...
  finProductionByClinician(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/Finance/fnProductionByClinician?clinic_id=' +
          clinic_id +
          '&start_date=' +
          startDate +
          '&end_date=' +
  ...
  finTotalProduction(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/Finance/fnTotalProduction?clinic_id=' +
          clinic_id +
          '&start_date=' +
          startDate +
          '&end_date=' +
  ...
  finCollection(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/Finance/fnTotalCollection?clinic_id=' +
          clinic_id +
          '&start_date=' +
          startDate +
          '&end_date=' +
  ...
  finProductionPerVisit(
    ...
    return this.http
      .get(
        this.apiUrl +
          '/Finance/fnProductionPerVisit?clinic_id=' +
          clinic_id +
          '&start_date=' +
          startDate +
          '&end_date=' +
