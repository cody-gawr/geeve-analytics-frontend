...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onSubmit = function () {
        var _this = this;
        this.loginService.checkEmailExists(this.form.value.email).subscribe(function (res) {
            _this.errorLogin = false;
            _this.errorLoginText = '';
            _this.successLogin = false;
            _this.successLoginText = '';
            if (res.message == 'success') {
                _this.loginService.addUser(_this.form.value.email, _this.form.value.password, '2', _this.plan_id).subscribe(function (res) {
                    _this.errorLogin = false;
                    _this.errorLoginText = '';
                    _this.successLogin = false;
                    _this.successLoginText = '';
                ...
                _this.errorLogin = true;
                _this.errorLoginText = 'Email already Exists!';
            }
        }, function (error) {
        });
    };
