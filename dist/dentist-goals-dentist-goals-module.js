...
module.exports = ".example-form {\n  min-width: 150px;\n  max-width: 500px;\n  width: 100%; }\n\n.example-full-width {\n  width: 90%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var angular_notifier__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! angular-notifier */ "./node_modules/angular-notifier/fesm5/angular-notifier.js");
...
var DentistGoalsComponent = /** @class */ (function () {
    function DentistGoalsComponent(notifierService, fb, dentistGoalsService, route, dentistService, _cookieService, router) {
        this.fb = fb;
    ...
    DentistGoalsComponent.prototype.initiate_clinic = function () {
    ...
    DentistGoalsComponent.prototype.initiate_dentist = function () {
    ...
    DentistGoalsComponent.prototype.onSubmit = function () {
        ...
        this.dentistGoalsService.updateDentistGoals(myJsonString, this.clinic_id, this.dentist_id).subscribe(function (res) {
            if (res.message == 'success') {
                _this.notifier.notify('success', 'Dentist Goals Updated', 'vertical');
            }
        }, function (error) {
            _this.warningMessage = "Please Provide Valid Inputs!";
        });
...
var DentistGoalsService = /** @class */ (function () {
    function DentistGoalsService(http, _cookieService, router) {
        var _this = this;
        this.http = http;
        this._cookieService = _cookieService;
        this.router = router;
