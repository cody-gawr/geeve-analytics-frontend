...
var DentistGoalsComponent = /** @class */ (function () {
    function DentistGoalsComponent(fb, dentistGoalsService, route) {
        this.fb = fb;
    ...
    DentistGoalsComponent.prototype.getDentistGoals = function () {
        var _this = this;
        this.dentistGoalsService.getDentistGoals(this.clinic_id).subscribe(function (res) {
            console.log(res);
    ...
    DentistGoalsComponent.prototype.onSubmit = function () {
        ...
        this.dentistGoalsService.updateDentistGoals(myJsonString, this.clinic_id).subscribe(function (res) {
            if (res.message == 'success') {
    ...
    DentistGoalsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _dentist_goals_service__WEBPACK_IMPORTED_MODULE_2__["DentistGoalsService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]])
...
var DentistGoalsService = /** @class */ (function () {
    ...
    // Get ClinicGoals
    DentistGoalsService.prototype.getDentistGoals = function (clinic_id, user_id, dentist_id, token) {
        if (clinic_id === void 0) { clinic_id = '1'; }
        if (user_id === void 0) { user_id = this._cookieService.get("userid"); }
        if (dentist_id === void 0) { dentist_id = '1'; }
    ...
    // Get ClinicGoals
    DentistGoalsService.prototype.updateDentistGoals = function (clinicData, clinic_id, user_id, token) {
        if (clinic_id === void 0) { clinic_id = '1'; }
        if (user_id === void 0) { user_id = this._cookieService.get("userid"); }
        if (token === void 0) { token = this._cookieService.get("token"); }
