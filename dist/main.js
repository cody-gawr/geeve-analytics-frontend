...
var map = {
	...
	"./charts/chartslib.module": [
		...
		"default~charts-chartslib-module~dashboard-dashboard-module~dashboards-dashboards-module",
		"default~charts-chartslib-module~dashboards-dashboards-module",
		"common",
		"charts-chartslib-module"
	],
...
var AppHeaderrightComponent = /** @class */ (function () {
    ...
    AppHeaderrightComponent.prototype.getClinics = function () {
        ...
        this.headerService.getClinics().subscribe(function (res) {
            if (res.message == 'success') {
                ...
                _this.loadClinicid(_this.selectedClinic);
    ...
    AppHeaderrightComponent.prototype.loadClinicid = function (clinicValue) {
...
var RolesUsersService = /** @class */ (function () {
    function RolesUsersService(http, _cookieService) {
        this.http = http;
        this._cookieService = _cookieService;
        this.apiUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl;
        //append headers
    ...
    // Get Dentist
    RolesUsersService.prototype.getUsers = function (user_id, clinic_id, token) {
        if (user_id === void 0) { user_id = this._cookieService.get("userid"); }
        if (clinic_id === void 0) { clinic_id = '1'; }
        if (token === void 0) { token = this._cookieService.get("token"); }
...
module.exports = __webpack_require__(/*! /var/www/html/jeevemembers/client2/src/main.ts */"./src/main.ts");
