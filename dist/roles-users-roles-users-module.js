...
module.exports = ".lds-roller div::after {\n  background: black; }\n\n.spinner {\n  position: relative;\n  background: none; }\n\n.mat-dialog-container {\n  min-width: 700px !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var RolesUsersComponent = /** @class */ (function () {
    ...
    RolesUsersComponent.prototype.initiate_clinic = function () {
    ...
    RolesUsersComponent.prototype.getUsers = function () {
        var _this = this;
        this.rolesUsersService.getUsers(this.clinic_id).subscribe(function (res) {
            _this.rows = [];
            if (res.message == 'success') {
                _this.rows = res.data;
    ...
    RolesUsersComponent.prototype.getRoles = function () {
        var _this = this;
        this.rolesUsersService.getRoles(this.clinic_id).subscribe(function (res) {
            if (res.message == 'success') {
                _this.roles = [];
                res.data.forEach(function (result) {
