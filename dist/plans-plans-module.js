...
var PlansComponent = /** @class */ (function () {
    ...
    PlansComponent.prototype.updateValue = function (event, cell, rowIndex) {
        ...
        if (event.target.value == '')
            ...
            this.plansService.updateUser(this.rows[rowIndex]['id'], this.clinic_id, this.rows[rowIndex][cell], cell).subscribe(function (res) {
                // console.log();
                if (res.message == 'success') {
                    alert('Plan Updated');
                    _this.getPlans();
...
var PlansService = /** @class */ (function () {
    ...
    // Update Clinic
    PlansService.prototype.updateUser = function (memberid, clinic_id, value, column, token) {
        if (token === void 0) { token = this._cookieService.get("token"); }
        var formData = new FormData();
