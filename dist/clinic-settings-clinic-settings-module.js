...
module.exports = ".example-form {\n  min-width: 150px;\n  max-width: 500px;\n  width: 100%; }\n\n.example-full-width {\n  width: 90%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ClinicSettingsComponent = /** @class */ (function () {
    function ClinicSettingsComponent(notifierService, _cookieService, fb, clinicSettingsService, route, router) {
        ...
        this.workingDays = { sunday: false, monday: false, tuesday: false, wednesday: false, thursday: false, friday: false, saturday: false };
        // For form validator
    ...
    ClinicSettingsComponent.prototype.ngOnInit = function () {
        ...
        this.form = this.fb.group({
            ...
            post_op_calls: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required])]
        });
    };
    ...
    ClinicSettingsComponent.prototype.getClinicSettings = function () {
        ...
        this.clinicSettingsService.getClinicSettings(this.id).subscribe(function (res) {
            if (res.message == 'success') {
                ...
                _this.post_op_calls = res.data[0].post_op_calls;
                _this.workingDays = JSON.parse(res.data[0].days);
            }
    ...
    ClinicSettingsComponent.prototype.onSubmit = function () {
        ...
        var days = JSON.stringify(this.workingDays);
        this.clinicSettingsService.updateClinicSettings(this.id, this.clinicName, this.address, this.contactName, this.practice_size, days, this.post_op_calls).subscribe(function (res) {
            if (res.message == 'success') {
    ...
    ClinicSettingsComponent.prototype.toggle = function (event) {
    ...
    ClinicSettingsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [angular_notifier__WEBPACK_IMPORTED_MODULE_5__["NotifierService"], angular2_cookie_core__WEBPACK_IMPORTED_MODULE_4__["CookieService"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _clinic_settings_service__WEBPACK_IMPORTED_MODULE_2__["ClinicSettingsService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
...
var ClinicSettingsService = /** @class */ (function () {
    function ClinicSettingsService(http, _cookieService, router) {
        var _this = this;
        this.http = http;
        this._cookieService = _cookieService;
        this.router = router;
    ...
    // Get ClinicSettings
    ClinicSettingsService.prototype.updateClinicSettings = function (clinic_id, name, address, contact_name, practice_size, workingDays, postOpCalls, user_id, token) {
