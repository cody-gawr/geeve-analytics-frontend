...
var ClinicGoalsComponent = /** @class */ (function () {
    function ClinicGoalsComponent(fb, clinicGoalsService) {
        this.fb = fb;
    ...
    ClinicGoalsComponent.prototype.getClinicGoals = function () {
        var _this = this;
        this.clinicGoalsService.getClinicGoals().subscribe(function (res) {
            console.log(res);
    ...
    ClinicGoalsComponent.prototype.onSubmit = function () {
        ...
        this.clinicGoalsService.updateClinicGoals(myJsonString).subscribe(function (res) {
            if (res.message == 'success') {
    ...
    ClinicGoalsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _clinic_goals_service__WEBPACK_IMPORTED_MODULE_2__["ClinicGoalsService"]])
...
var ClinicGoalsService = /** @class */ (function () {
    function ClinicGoalsService(http, _cookieService) {
        this.http = http;
    ...
    // Get ClinicGoals
    ClinicGoalsService.prototype.getClinicGoals = function (user_id, clinic_id, token) {
        if (user_id === void 0) { user_id = '23'; }
        if (clinic_id === void 0) { clinic_id = '1'; }
        if (token === void 0) { token = this._cookieService.get("token"); }
        return this.http.get("http://localhost/jeeveanalytics/server/ClinicGoals/getClinicGoals?user_id=" + user_id + "&clinic_id=" + clinic_id + "&token=" + this._cookieService.get("token"), { headers: this.headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (response) {
            return response;
        }));
    };
    // Get ClinicGoals
    ClinicGoalsService.prototype.updateClinicGoals = function (clinicData, user_id, clinic_id, token) {
        if (user_id === void 0) { user_id = '23'; }
        if (clinic_id === void 0) { clinic_id = '1'; }
        if (token === void 0) { token = this._cookieService.get("token"); }
        ...
        return this.http.post("http://localhost/jeeveanalytics/server/ClinicGoals/add/", formData)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (response) {
            return response;
        }));
    };
